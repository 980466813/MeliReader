...
public class BottomBarTab extends FrameLayout {
    ...
    private void init(Context context, int icon, CharSequence title) {
        ...
        mIcon.setColorFilter(ContextCompat.getColor(context, R.color.md_grey_500));
        ...
        mTvTitle.setTextColor(ContextCompat.getColor(context, R.color.md_grey_500));
    ...
    public void setSelected(boolean selected) {
        ...
        if (selected) {
            ...
            mIcon.setColorFilter(ContextCompat.getColor(mContext, R.color.md_grey_500));
            mTvTitle.setTextColor(ContextCompat.getColor(mContext, R.color.md_grey_500));
        }
    }
